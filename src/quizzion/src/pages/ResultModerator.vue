<template>
  <div class="column items-center fullscreen"  :style="quiz">
    <div class="row">
    ...
    <div class="row" style="background-color:white; width:80%;border-radius: 15px 15px 15px 15px;padding: 10px">

      <q-list style="width:100%">
        <table>
          <tr>
          <th style="width:5%">No</th>
          <th style="width:95%;">Player</th>
